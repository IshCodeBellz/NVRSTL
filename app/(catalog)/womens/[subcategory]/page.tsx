...
export default async function WomensSubcategoryPage({
  ...
  const categorySlug = `womens-${subcategory}`;
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-500 mb-8">
          ...
          <span>/</span>
          <Link href="/womens" className="hover:text-gray-700">
            Women&apos;s
          </Link>
          <span>/</span>
...
export async function generateMetadata({ params }: PageProps) {
  ...
  return {
    title: `${category.name} - Women's | DY Official`,
    description: `Shop ${category.name} for women at DY Official`,
  };
}
