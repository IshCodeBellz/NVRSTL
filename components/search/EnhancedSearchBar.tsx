    ...
    <div ref={searchRef} className="relative w-full max-w-2xl mx-auto">
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-3 pl-12 pr-12 text-sm border border-neutral-300 dark:border-neutral-600 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-white placeholder:text-neutral-500 dark:placeholder:text-neutral-400"
        />
      ...
      {/* Search Dropdown */}
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg shadow-lg z-[100] max-h-96 overflow-y-auto">
          {loading && (
            <div className="p-4 text-center text-neutral-500 dark:text-neutral-400">
              <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-neutral-400 dark:border-neutral-500 mx-auto"></div>
            </div>
          )}
            ...
            <div className="py-2">
              {suggestions.map((suggestion, index) => (
                <button
                  ...
                  className={`w-full px-4 py-2 text-left hover:bg-neutral-50 dark:hover:bg-neutral-700 flex items-center gap-3 ${
                    selectedIndex === index
                ...
                <div className="mb-4">
                  <div className="flex items-center justify-between px-4 py-2 border-b border-neutral-100 dark:border-neutral-700">
                    ...
                    <button
                      ...
                      className="text-xs text-neutral-500 dark:text-neutral-400 hover:text-neutral-700 dark:hover:text-neutral-200 px-2 py-1 hover:bg-neutral-50 dark:hover:bg-neutral-700 rounded"
                    >
                      Clear
                    </button>
                  </div>
                  <div className="max-h-40 overflow-y-auto">
                    {recentSearches.slice(0, 5).map((search, index) => (
                      <button
                        ...
                        className={`w-full px-4 py-3 text-left hover:bg-neutral-50 dark:hover:bg-neutral-700 flex items-center gap-3 transition-colors ${
                          selectedIndex === index
                            ? "bg-neutral-50 dark:bg-neutral-700"
                            : ""
                        }`}
                  ...
                  <div className="max-h-40 overflow-y-auto">
                    {trendingSearches.slice(0, 8).map((search, index) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <span className="text-sm text-neutral-700 dark:text-neutral-200 truncate block">
                            {search.query}
                          </span>
                        </div>
          ...
          {!loading &&
            ...
            query.trim() && (
              <div className="px-4 py-8 text-center text-neutral-500">
                <p className="text-sm mb-2">No suggestions found</p>
                <button
                  onClick={() => handleSearch()}
                  className="inline-flex items-center gap-2 px-4 py-2 text-sm text-blue-600 hover:text-blue-500 hover:bg-blue-50 rounded-md transition-colors"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
